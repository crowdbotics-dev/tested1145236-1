"""
Django settings for tested1145236_1 project.
...
ROOT_URLCONF = 'tested1145236_1.urls'
...
WSGI_APPLICATION = 'tested1145236_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tested1145236 Support <support@tested1145236-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tested1145236_1 API",
    "DESCRIPTION": "API documentation for tested1145236_1 App",
    "VERSION": "v1",
}
